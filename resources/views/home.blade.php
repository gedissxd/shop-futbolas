<x-layout title="Home">
    <div class="relative">
        ...
        <div class="absolute inset-0 flex items-center justify-center">
            <flux:button variant="primary" class="text-white" href="{{ route('products') }}" wire:navigate >Start shopping</flux:button>
        </div>
    </div>
    <h1 class="text-center text-2xl font-bold mt-10">Featured products</h1>
