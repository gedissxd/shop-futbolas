<div>
    ...
    <flux:radio.group label="{{ __('Pickup Method') }}">
        ...
        <flux:radio value="terminal" wire:click="setPickupMethod('terminal')" label="{{ __('LP Express Terminal') }} (3€)" name="pickupMethod"/>

        <flux:radio value="omniva" wire:click="setPickupMethod('omniva')" label="{{ __('Omniva Terminal') }} (3€)" name="pickupMethod"/>
